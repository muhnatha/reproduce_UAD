...
class Fusion:
    def __init__(self, pcd, data, rescale_params=None):
        ...
        self.raw_features = data['features'] # [num_cam, H, W, feat_dim]; Dino features extracted from images
    ...
    def fused_link_segs(self):
        ...
        for label in np.unique(self.projected_link_segs):
            ...
            update = count > max_count # boolean array
    ...
    def view_projection_to_cam_3d(self, frame_idx, labels=None, label_discrete=False, n_neighbors=1,bg_val=1):
        """
        Project labels to camera view by finding the closest point to the projected point. nearest neighbor
        """
