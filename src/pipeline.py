...
# from utils.utils import find_similarity already defined in this file
...
def find_best_camera_angle(h5_file_path, top_k=3):
    ...
    # tokenize the category name and get the text embedding
    ...
    with h5py.File(h5_file_path, 'r') as h5_file:
        ...
        for instance_key in instance_keys:
            ...
            clip_similarities = find_similarity(all_image_features, text_embeds) # in VLM, images and text are projected to the same feature space
